...
mixin _$TasksDaoMixin on DatabaseAccessor<TodoDatabase> {
  $TasksTable get tasks => attachedDatabase.tasks;
}

class $TasksTable extends Tasks with TableInfo<$TasksTable, TodoTask> {
  @override
...
class TodoTask extends DataClass implements Insertable<TodoTask> {
  ...
  TodoTask copyWithCompanion(TasksCompanion data) {
    return TodoTask(
...
abstract class _$TodoDatabase extends GeneratedDatabase {
  ...
  late final TasksDao tasksDao = TasksDao(this as TodoDatabase);
  @override
...
class $$TasksTableFilterComposer extends Composer<_$TodoDatabase, $TasksTable> {
...
class $$TasksTableOrderingComposer
    extends Composer<_$TodoDatabase, $TasksTable> {
...
class $$TasksTableTableManager
    extends
        RootTableManager<
          ...
          (TodoTask, BaseReferences<_$TodoDatabase, $TasksTable, TodoTask>),
          TodoTask,
          PrefetchHooks Function()
        > {
  $$TasksTableTableManager(_$TodoDatabase db, $TasksTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
